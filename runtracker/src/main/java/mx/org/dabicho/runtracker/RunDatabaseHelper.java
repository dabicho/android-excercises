...
public class RunDatabaseHelper extends SQLiteOpenHelper {
    ...
    public long insertLocation(long runId, Location location) {
        ...
        cv.put(COLUMN_LOCATION_ALTITUDE, location.getAccuracy());
    ...
    public RunCursor queryRun(long id) {
        Cursor wrapped = getReadableDatabase().query(TABLE_RUN, null // Todas las columnas
                , COLUMN_RUN_ID+" = ?" // por id (WHERE)
                , new String[]{String.valueOf(id)} //Con este valor (VALORES POR PARAMETROS)
                , null // sin group by
                , null // ni order by
                , null // ni having
                , "1" // un resultado
    ...
    public static class RunCursor extends CursorWrapper {
        ...
        /**
         * Devuelve un objeto Run configurado para el renglón actual o null si el renglón actual es
         * inválido.
         */
        public Run getRun() {
